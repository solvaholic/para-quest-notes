...
> **Status:** v0.2 shipped. CLI surface and JSON contracts are
...
```bash
uv tool install git+https://github.com/solvaholic/para-quest-notes@v0.2.1
# or
pipx install git+https://github.com/solvaholic/para-quest-notes@v0.2.1
```
