...
> **Status:** v0.3 shipped. CLI surface and JSON contracts are
...
```bash
uv tool install git+https://github.com/solvaholic/para-quest-notes@v0.3.0
# or
pipx install git+https://github.com/solvaholic/para-quest-notes@v0.3.0
```
